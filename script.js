...
class AnotherScene extends Phaser.Scene {
    ...
    create() {
        ...
        const textGame = this.add.text(20, 450, ' Play the game: Memorise pairs of film making items from history. When the cards are turned over, click the pairs and beat the timer!', { font: 'bold 30px Times New Roman', fill: '#34eb92', wordWrap: { width: 760, useAdvancedWrap: true } });
